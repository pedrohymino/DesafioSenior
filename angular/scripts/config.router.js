      ...
      function config( $stateProvider,   $urlRouterProvider,   MODULE_CONFIG  ) {
        ...
        $stateProvider
          .state('app', {
            ...
            .state('app.contatos', {
              url: '/contatos',
              templateUrl: 'views/app/contatos.html',
              data : { title: 'Contato' },
              controller: "ContactController",
              resolve: load(['mgcrea.ngStrap','ui.bootstrap','ui.select','scripts/controllers/app/contactController.js']),
            })
